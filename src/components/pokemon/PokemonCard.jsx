    ...
    >
      <Link to={`/pokemon/${pokemon.id}`} className="block">
        <div className="glass rounded-2xl p-4 card-hover relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-poke-yellow/5 via-transparent to-poke-blue/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
          ...
          <div className="relative z-[1]">
            ...
            <h3 className="text-center font-display font-bold text-white capitalize text-lg mb-2 group-hover:text-poke-yellow transition-colors">
